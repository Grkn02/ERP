...
namespace ERP.Models
{
    ...
    public class User
    {
        ...
        public string PasswordHash { get; set; } = string.Empty; // kullanıcıdan aldığımız plain text şifreyi hashleme fonskiyonu ile şifeleyip kayıt esnasında DB ye yükelriz. Loginde de tam tersi.
